function MiniStatBox({ text, stat, description }) {
  return (
      <div className="relative group p-4 bg-gray-100 rounded-lg shadow-md hover:bg-gray-200 cursor-pointer h-full w-full max-w-xs mx-auto sm:max-w-sm md:max-w-md">
          ...
          <div className="absolute left-1/2 bottom-full w-48 -translate-x-1/2 bg-black text-white text-sm p-2 rounded-lg opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity duration-200 shadow-lg min-w-max text-center z-10">
              {description}
          </div>
